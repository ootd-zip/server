...
public class InMemoryDynamicClientRegistrationRepository
    ...
    public InMemoryDynamicClientRegistrationRepository(Map<String, ClientRegistration> registrations,
            List<ClientSecretGenerator> secretGenerators) {
    ...
    private Map<String, ClientSecretGenerator> createSecretGeneratorsMap(List<ClientSecretGenerator> secretGenerators) {
        ...
        for (ClientSecretGenerator generator : secretGenerators) {
            Assert.state(!result.containsKey(generator.getRegistrationId()),
                    () -> String.format("Duplicate key %s", generator.getRegistrationId()));
